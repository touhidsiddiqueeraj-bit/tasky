...
KeyActionAny letter/numberOpen floating input to add a taskEnterSave taskEscCancel input / deselect taskClick a taskSelect it← →Move selected task between columns1 2 3Set priority High / Medium / Low on selected taskDeleteDelete selected task (with undo)Alt+1–9Select task by numberAlt+GEnter goto mode (type number + Enter)Hold SpaceVoice dictation (desktop only)
...
Browser Support
BrowserTasksVoiceCloud SyncChrome 90+✅✅✅Edge 90+✅✅✅Brave✅✅✅Firefox✅❌ (no Web Speech API)✅Safari✅⚠️ (partial, may need permission reset)✅
